    ...
    <div className="flex flex-col border-[2px] p-3 border-white saturate-[2] dark:saturate-[1] py-3 rounded-xl">
      <div className="relative flex items-center gap-4">
        <input
          ...
          minLength={1}
          maxLength={79}
          className="placeholder-white text-gray-900 dark:text-slate-50 text-left border-none focus:outline-none focus:ring-0 p-0 bg-transparent w-full truncate font-medium without-ring !text-3xl py-1"
          testdata-id="undefined-input"
          value=""
        />
        <button
          id="undefined-button"
          className="flex items-center justify-end gap-1 pl-2 pr-2 text-xl rounded-full text-white/90 bg-black/30 "
        >
          <div className="flex-1 w-[90px] h-[50px] pt-1.5 mr-0.5 text-white">
      ...
      <div className="flex flex-row items-center justify-between h-[36px]">
        ...
        >
          ...
          <span className="text-lg">
            <span className="text-sm font-semibold text-white">000000</span>
          </span>
        </button>
      </div>
    </div>
